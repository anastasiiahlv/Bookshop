...
namespace BookshopInfrastructure.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public AuthorsController(DbbookshopContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Books(int? id)
        {
            ...
            return RedirectToAction("BooksByAuthor", "Books", new { id = author.Id, firstName = author.FirstName, lastName = author.LastName });
        }
